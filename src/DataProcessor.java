        ...
        for (Row row : sheet) {
            ...
            if (i > 1) {
                ...
                if (dateA != null) {
                    ...
                    Flight flight = new Flight(dateA, AH, terminal, pernocta, aircraftA, airlineA, numA, timeA, origenAirport, AA, flightTypeA, zonaLA, dateD, airlineD, numD, timeD, as, af, flightTypeD, zonaSA, aircraftD, seats, numWeek, dayWeek, null, null, null, null, "F", "N", null, null);
